      ...
      <div style={{
        ...
        <div style={{ fontSize: "14.5px", color: "#94a3b8", lineHeight: "1.7", display: "flex", flexDirection: "column", gap: "24px", textAlign: "justify" }}>
          ...
          <section>
            ...
            <ul style={{ paddingLeft: "20px", marginBottom: "12px", listStyleType: "disc" }}>
              <li><strong>Three-Provider LLM Fallback Pipeline:</strong> Converting unstructured placement emails into structured application records using OpenAI GPT-OSS 20B (via NVIDIA NIM) as primary, with automated fallback to OpenAI GPT-OSS 120B (via Groq) and Mistral Small (via Mistral AI).</li>
          ...
          <section>
            ...
            <ul style={{ paddingLeft: "20px", marginBottom: "12px", listStyleType: "disc" }}>
              ...
              <li><strong>LLM Inference Providers (NVIDIA NIM, Groq, Mistral AI):</strong> For structured extraction using OpenAI GPT-OSS (20B & 120B) and Mistral Small models under strict developer terms without retaining customer prompt data for AI model training.</li>
